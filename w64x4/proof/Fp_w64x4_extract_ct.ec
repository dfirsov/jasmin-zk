...
module M = {
  ...
  proc cminusP (x:W64.t Array4.t) : W64.t Array4.t = {
    ...
    twop63 <- aux_1;
    leakages <- LeakAddr([0]) :: leakages;
    (aux_2, aux_1) <- addc_64 t.[0] (W64.of_int 19) false;
    cf <- aux_2;
    leakages <- LeakAddr([0]) :: leakages;
    t.[0] <- aux_1;
    leakages <- LeakAddr([1]) :: leakages;
    (aux_2, aux_1) <- addc_64 t.[1] (W64.of_int 0) cf;
    cf <- aux_2;
    leakages <- LeakAddr([1]) :: leakages;
    t.[1] <- aux_1;
    leakages <- LeakAddr([2]) :: leakages;
    (aux_2, aux_1) <- addc_64 t.[2] (W64.of_int 0) cf;
    cf <- aux_2;
    leakages <- LeakAddr([2]) :: leakages;
    t.[2] <- aux_1;
    leakages <- LeakAddr([3]) :: leakages;
    (aux_2, aux_1) <- addc_64 t.[3] twop63 cf;
    cf <- aux_2;
    leakages <- LeakAddr([3]) :: leakages;
    t.[3] <- aux_1;
    leakages <- LeakAddr([0; 0]) :: leakages;
