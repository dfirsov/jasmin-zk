...
op oneR : R = R.A.of_list W64.one
                 [ W64.one; W64.zero; W64.zero; W64.zero ].


print R.                 
op as_w64 (x : bool) : W64.t  = x ? W64.one : W64.zero.
op ith_bitword64 (n : W64.t) (x : int)  : W64.t = as_w64 (n.[x]).
op Rbits (n : R) : bool list.
op bitsR (n : bool list) : R.
op ith_bitR (n : R) (x : int)  : W64.t.

op ( *** ) (a b : R) : R = R.bn_ofint ((valR a * valR b)  %%  P).                 
