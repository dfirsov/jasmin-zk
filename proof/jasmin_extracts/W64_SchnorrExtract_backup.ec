...
module M(SC:Syscall_t) = {
  ...
  proc commitment () : W64.t Array32.t * W64.t Array32.t = {
    ...
    secret_power <@ usample (group_generator);
    commitment_0 <@ expm (barrett_parameter, group_generator,
  ...
  proc response (witness0:W64.t Array32.t, secret_power:W64.t Array32.t,
    ...
    group_generator <@ bn_set_gg (group_generator);
    barrett_parameter <@ bn_set_bf (barrett_parameter);
    product <@ mulm (barrett_parameter, group_generator, challenge, witness0);
  ...
  proc challenge () : W64.t Array32.t = {
    ...
    group_generator <- witness;
    group_generator <@ bn_set_gg (group_generator);
    challenge_0 <@ usample (group_generator);
    return (challenge_0);
  }
  ...
  proc verify (statement:W64.t Array32.t, commitment:W64.t Array32.t,
               challenge_0:W64.t Array32.t, response:W64.t Array32.t) : 
  W64.t = {
