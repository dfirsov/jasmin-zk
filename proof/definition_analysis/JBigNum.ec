...
(* From this point, the script needs to be pruned from no longer needed defs... Most of it is already superseeded (or shall be soon) by the "bn_base_proof.ec". *)
