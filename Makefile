...
EXTRACTED_FUNCTIONS = -ec challenge_indexed -ec commitment_indexed -ec usample -ec addm -ec addm2 -ec commitment -ec response -ec challenge -ec verify -ec bn_set_ex_w -ec bn_set_ex_s
