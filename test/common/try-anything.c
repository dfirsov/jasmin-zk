...
void double_canary_u64(uint64_t *x2, uint64_t *x, uint64_t xlen)
{ double_canary((uint8_t*)x2, (uint8_t*)x, xlen); }
...
void input_prepare_u64(uint64_t *x2, uint64_t *x, uint64_t xlen)
{  input_prepare((uint8_t*)x2, (uint8_t*)x, xlen); }
...
void input_compare_u64(const uint64_t *x2, const uint64_t *x, uint64_t xlen, const char *fun)
{ input_compare((uint8_t*)x2, (uint8_t*)x, xlen, fun); }
...
void output_prepare_u64(uint64_t *x2, uint64_t *x, uint64_t xlen)
{ output_prepare((uint8_t*)x2, (uint8_t*)x, xlen); }
...
void output_compare_u64(const uint64_t *x2, const uint64_t *x, uint64_t xlen, const char *fun)
{ output_compare((uint8_t*)x2, (uint8_t*)x, xlen, fun); }
...
void checksum_u64(uint8_t *checksum_state, uint64_t *x, uint64_t xlen)
{ checksum(checksum_state, (uint8_t*)x, xlen); }
...
uint64_t* alignedcalloc_u64(void** c, uint64_t len)
{
  return (uint64_t*) alignedcalloc(c, len);
}
